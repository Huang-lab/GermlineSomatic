...
### MAIN ###
somaticDriver299_f = "../../../../Huang_lab_data/TCGA_PanCanAtlas_2018/Driver_BaileyCell2018/299driverGene.txt"
somaticDriver299 = as.vector(t(read.table(header=F, quote = "", sep="\t", file = somaticDriver299_f, stringsAsFactors=FALSE)))

somatic_f = "../../../../Huang_lab_data/TCGA_PanCanAtlas_2018/MC3/mc3.v0.2.8.PUBLIC.maf.gene_vclass_HGVSp_sample.gz"
...
# driver mutation
driver_f = "../../../../Huang_lab_data/TCGA_PanCanAtlas_2018/Driver_BaileyCell2018/Mutation.CTAT.3D.Scores.txt.gz"
...
somatic_likelyfunctional_driver_loose = somatic_likelyfunctional[somatic_likelyfunctional$Variant_Classification != "Missense_Mutation" |
                                                             paste(somatic_likelyfunctional$Hugo_Symbol,somatic_likelyfunctional$HGVSp_Short) %in% paste(driver_func$gene,driver_func$protein_change),]
